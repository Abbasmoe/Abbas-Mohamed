<template>
  <main class="md:mt-18 mt-12 flex flex-col items-center gap-24">
    <h1 class="wavy-text text-4xl font-bold">About me</h1>

    <div class="flex flex-col gap-20">
      <div class="flex w-full max-w-4xl flex-col gap-2">
        <span class="i-[mdi--code-tags] size-8 bg-secondary"></span>
        <div class="flex flex-col pl-2">
          <h3 class="font-semibold">Hi, I'm Abbas</h3>
          <p class="text-pretty">
            ...
            high-quality code solutions and a keen eye for appealing design, as
            well as for effective collaboration with cross-functional teams. I
            am dedicated to lifelong learning and personal growth. 💪
          </p>
        </div>
        <span class="i-[mdi--code] size-8 self-end bg-secondary"></span>
      </div>
      <div class="flex w-full max-w-4xl flex-col gap-8">
        ...
        <ul class="flex items-center justify-center gap-12">
          <li class="flex flex-col items-center gap-2">
            <SvgTypeScript class="size-12" />
            <p class="text-sm">TypeScript</p>
          </li>
          <li class="flex flex-col items-center gap-2">
            <SvgTailwindcss class="size-12" />
            <p class="text-sm">Tailwind CSS</p>
          </li>
          <li class="flex flex-col items-center gap-2">
            <SvgNuxt class="size-12" />
      ...
      <div class="flex w-full max-w-4xl flex-col gap-12">
        <h2 class="font-semibold">Languages I speak 🗣</h2>
        <ul class="flex items-center justify-center gap-16">
          <li class="flex flex-col items-center gap-2">
            <SvgSudan class="size-12" />
            <p class="text-sm">Arabic</p>
          </li>
          <li class="flex flex-col items-center gap-2">
            <SvgGermany class="size-12" />
            <p class="text-sm">German</p>
          </li>
          <li class="flex flex-col items-center gap-2">
            <SvgUSA class="size-12" />
